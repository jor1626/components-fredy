import { Component, OnInit, AfterViewInit, OnDestroy, ViewChildren, ChangeDetectorRef } from '@angular/core';
...
import * as fromPerdidasGanancias from './../store/actions/perdidas-ganancias.actions';
import * as fromReports from './../store/actions/reporte.actions';
...
export class EstadoResultadoComponent implements OnInit, OnDestroy, AfterViewInit {
